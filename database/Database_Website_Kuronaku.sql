...
-- Dumping data for table webdailyjournal.gallery: ~0 rows (approximately)
...
-- Dumping data for table webdailyjournal.user: ~2 rows (approximately)
INSERT INTO `user` (`id`, `username`, `password`, `foto`) VALUES
	(1, 'admin', '$2y$10$HNNSp..MIhb7v75rAlZh3e4Q5r7w067WxqK1gR2WlmV7r5xMBiLQG', 'profile/1768372262_877.png'),
	(2, 'april', '$2y$10$NJLtVaata2QgfVZil2Qxiu6f0ebIKg./hy43ASr6PGYC960ylwIUm', 'profile/1768382318_595.png');
